...
THEANO_FLAGS='floatX=float32,mode=FAST_RUN,allow_gc=False,device=gpu,lib.cnmem=0.9' python runs/run_{exp_name}.py 2>&1 | multilog t s100000 '!tai64nlocal|gzip' ./logs &

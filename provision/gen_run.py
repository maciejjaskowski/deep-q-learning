...
THEANO_FLAGS='floatX=float32,mode=FAST_RUN,allow_gc=False,device=gpu,lib.cnmem=0.9' python run.py --game=space_invaders --network=nature_with_pad_he --updates=deepmind_rmsprop 2>&1 | multilog t s500000 '!tai64nlocal|gzip' ./logs &

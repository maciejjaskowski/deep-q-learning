...
THEANO_FLAGS='floatX=float32,mode=FAST_RUN,allow_gc=False,device=gpu,lib.cnmem=0.9' python run.py --dqn.final_epsilon=0.1 --dqn.initial_epsilon=0.1 --show_mood=Log --dqn.no_replay --record_dir=record0.1 --dqn.network=cnn_gpu --dqn.updates=deepmind_rmsprop 2>&1 | multilog t s100000 '!tai64nlocal|gzip' ./logs &
